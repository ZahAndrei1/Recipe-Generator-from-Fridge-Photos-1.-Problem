...
if __name__ == "__main__":
    ...
    processed_pkl_path = os.path.join(script_dir, 'recipes_processed.pkl')
    database_pkl_path = os.path.join(script_dir, 'recipes_database.pkl')

    # Download dataset if not present
    if not os.path.exists(csv_path):
        print(f"Downloading dataset to {csv_path}...")
        path = kagglehub.dataset_download("shuyangli94/food-com-recipes-and-user-interactions")
        shutil.move(os.path.join(path, "RAW_recipes.csv"), csv_path)
    else:
